...
const Gallery3 = () => {
  const projectImages = [
    // Single image - art1_1.jpg
    {
      type: 'single',
      id: 'single1',
      src: "/images/art-gallery3/art1_1.jpg",
    ...
    // Single image - art1_1.jpg
    {
      type: 'single',
      id: 'single2',
      src: "/images/art-gallery3/art1_2-4.jpg",
    ...
    },
    {
      ...
      images: [
        {
          src: "/images/art-gallery3/art1_5.jpg",
          alt: "DCC Eastern Adventures Character Sheet"
        },
        {
          src: "/images/art-gallery3/art1_6.jpg",
          alt: "Labrynth Lord Character Sheet"
        },
        {
          src: "/images/art-gallery3/art1_7.jpg",
    ...
    // Single image - art1_1.jpg
    {
      type: 'single',
      id: 'single3',
      src: "/images/art-gallery3/art1_8-10.jpg",
    ...
    // Triple images - art1_11.jpg, art1_12.jpg, and art1_13.jpg
    {
      ...
      images: [
        {
          src: "/images/art-gallery3/art1_11.jpg",
          alt: "Beneath the Giant's Head Module Cover"
        },
        {
          src: "/images/art-gallery3/art1_12.jpg",
          alt: "The Cate and the Resurection Module Cover"
        },
        {
          src: "/images/art-gallery3/art1_13.jpg",
    ...
    // Triple images - art1_14.jpg, art1_15.jpg, and art1_16.jpg
    {
      ...
      images: [
        {
          src: "/images/art-gallery3/art1_14.jpg",
          alt: "Mutant Crawl Classics Character Sheet"
        },
        {
          src: "/images/art-gallery3/art1_15.jpg",
          alt: "Basic Fantasy RPG Character Sheet"
        },
        {
          src: "/images/art-gallery3/art1_16.jpg",
